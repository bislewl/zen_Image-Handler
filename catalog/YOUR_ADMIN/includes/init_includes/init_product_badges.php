...
$module_constant = 'PRODUCT_BADGES_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/product_badges'; // This is the directory your installer is in, usually this is lower case
$module_name = "Product Badges"; // This should be a plain English or Other in a user friendly way
